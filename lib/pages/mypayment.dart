...
void main() {
  MpesaFlutterPlugin.setConsumerKey("8tSvHd99zN0UJkDPBnmZ4nYxIZGuek6o");
  MpesaFlutterPlugin.setConsumerSecret("9AQpupNi2YiofVTM");
...
//This url has been generated from http://mpesa-requestbin.herokuapp.com/?ref=hackernoon.com for test purposes
              accountReference: "Garage Automobile Services",
...
//This passkey has been generated from Test Credentials from Safaricom Portal
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('Garage Automobile Services'),
          centerTitle: true,
        ),
        body: Center(
          child: Container(
